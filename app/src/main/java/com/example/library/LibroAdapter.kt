...
class LibroAdapter : RecyclerView.Adapter<LibroAdapter.LibroViewHolder>() {
    ...
    override fun onBindViewHolder(holder: LibroViewHolder, position: Int) {
        ...
        holder.textViewFicha.text = "Ficha: ${libro.woResultadoOpacPK.ficha}"
        holder.textViewTitulo.text = "Titulo: ${libro.titulo}"
        holder.textViewAutor.text = "Autor: ${libro.autor}"
        holder.textViewISBN.text = "ISBN: ${libro.isbn}"
        holder.textViewEditorial.text = "Editorial: ${libro.editorial}"

        holder.imageViewPortada.setImageResource(R.drawable.icon_libro)
